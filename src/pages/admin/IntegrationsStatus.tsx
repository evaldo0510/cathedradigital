...
const integrations: Integration[] = [
  ...
  },
  {
    ...
    category: "IA",
    status: "connected",
    description: "Modelos de IA (chat, embeddings, imagens) sem chave própria.",
    howTo: "Disponível automaticamente via LOVABLE_API_KEY nas edge functions.",
  },
  {
  ...
  },
  {
    ...
    howTo: "Existe no workspace mas ainda não vinculado a este projeto.",
  },
  {
    name: "Mercado Pago",
    category: "Pagamentos",
    ...
    howTo: "Adicione MERCADOPAGO_ACCESS_TOKEN via secrets após criar app no painel MP.",
