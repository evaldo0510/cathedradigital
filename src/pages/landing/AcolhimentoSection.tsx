        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <motion.div 
              ...
              className="space-y-4 p-8 bg-card rounded-[2.5rem] border border-border/50 shadow-sm hover:shadow-premium-hover hover:border-primary/20 transition-all duration-300"
            >
