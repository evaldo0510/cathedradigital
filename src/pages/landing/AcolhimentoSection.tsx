        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <motion.div 
              ...
              className="space-y-4 p-8 bg-card rounded-[2.5rem] border border-border/50 shadow-sm hover:shadow-premium hover:border-primary/20 transition-all duration-300"
            >
              <div className="w-10 h-10 bg-primary/10 rounded-premium-sm flex items-center justify-center text-primary" aria-hidden="true">
                {item.icon}
              </div>
