...
const FaqSection = () => (
  <section className="w-full section-spacing relative overflow-hidden">
    <div className="app-container max-w-4xl space-y-3xl relative z-10">
      ...
      <Accordion type="single" collapsible className="space-y-md">
        {faqs.map((faq, i) => (
          <AccordionItem key={i} value={`faq-${i}`} className="rounded-premium border border-border bg-card text-card-foreground shadow-md transition-all duration-300 hover:shadow-premium hover:border-primary/20 !p-0 px-lg sm:px-xl overflow-hidden focus-within:ring-2 focus-within:ring-primary focus-within:ring-offset-2">
