...
const AboutCreatorSection = () => {
  ...
  return (
    <section className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-primary/2 rounded-2xl pointer-events-none" />
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-20">
          ...
          >
            <div className="relative">
              <div className="w-40 h-40 md:w-48 md:h-48 rounded-2xl border border-border/10 p-1 relative bg-background">
                <div className="w-full h-full rounded-2xl bg-muted flex items-center justify-center overflow-hidden border border-border/10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary/5 rounded-2xl">
