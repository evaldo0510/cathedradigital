...
const CommunitySection = () => {
  const communityFeatures = [
    {
      ...
      icon: <Users className="w-lg h-lg" />,
      tag: "Intercessão"
    },
    {
    ...
    },
    {
      ...
      icon: <MessageSquare className="h-lg w-lg" />,
      tag: "Testemunho"
    }
  ];
  ...
  return (
    <section className="w-full py-4xl px-md bg-background relative overflow-hidden">
      <div className="absolute top-2xs/2 left-2xs/2 -translate-x-1/2 -translate-y-1/2 w-3xl h-3xl bg-primary/[0.02] rounded-premium pointer-events-none" />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-lg">
          {communityFeatures.map((feature, i) => (
            ...
            >
              ...
              <h3 className="font-bold mb-md font-serif">{feature.title}</h3>
