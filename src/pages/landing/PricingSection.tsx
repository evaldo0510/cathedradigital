      ...
      <div className="app-container space-y-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-10">
          {tiers.map((tier) => (
            ...
            >
              {tier.popular && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-secondary text-primary-foreground text-premium-tiny font-bold uppercase tracking-[0.3em] px-4 py-1.5 rounded-premium-sm">
                  Mais Escolhido
                </div>
              )}
              ...
              <div className="space-y-6 flex-1">
                <div className="flex justify-between items-center">
                  <div className="w-12 h-12 rounded-premium-sm bg-primary/5 flex items-center justify-center">
                    {tier.icon}
                  </div>
