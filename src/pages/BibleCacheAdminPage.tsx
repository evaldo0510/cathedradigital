...
export default function BibleCacheAdminPage() {
  ...
  return (
    <div className="container mx-auto max-w-7xl space-y-spacing-lg px-spacing-md py-spacing-xl">
      ...
      <div className="grid grid-cols-2 gap-spacing-sm md:grid-cols-6">
      ...
      <Tabs defaultValue="charts">
          ...
          <Card className="overflow-auto p-spacing-md">
            ...
            <table className="w-full text-sm">
              <thead className="text-left text-xs uppercase text-muted-foreground">
                <tr>
                  <th className="py-spacing-xs pr-3">Livro</th>
                  <th className="py-spacing-xs pr-3">Total</th>
                  <th className="py-spacing-xs pr-3">Hit</th>
                  <th className="py-spacing-xs pr-3">Miss</th>
                  <th className="py-spacing-xs pr-3">Stale</th>
                  <th className="py-spacing-xs pr-3">Hit rate</th>
                  <th className="py-spacing-xs pr-3">avg (ms)</th>
                  <th className="py-spacing-xs pr-3">p95 (ms)</th>
                  <th className="py-spacing-xs pr-3">Bolls rate</th>
                </tr>
              </thead>
              <tbody>
                {sortedBooks.map((b) => (
                  ...
                  >
                    <td className="py-spacing-xs pr-3 font-mono">{b.abbrev}</td>
                    <td className="py-spacing-xs pr-3">{b.total}</td>
                    <td className="py-spacing-xs pr-3">{b.hits}</td>
                    <td className="py-spacing-xs pr-3">{b.misses}</td>
          ...
          <Card className="space-y-spacing-sm p-spacing-md">
            ...
            <div className="overflow-auto">
              <table className="w-full text-sm">
                <thead className="text-left text-xs uppercase text-muted-foreground">
                  <tr>
                    <th className="py-spacing-xs pr-3">Quando</th>
                    <th className="py-spacing-xs pr-3">Usuário</th>
                    <th className="py-spacing-xs pr-3">Ação</th>
                    <th className="py-spacing-xs pr-3">Alvo</th>
                    <th className="py-spacing-xs pr-3">Intervalo</th>
                    <th className="py-spacing-xs pr-3">Qtd</th>
                    <th className="py-spacing-xs pr-3">Ok/Falha</th>
                  </tr>
                </thead>
                <tbody>
        ...
        <TabsContent value="compare" className="space-y-spacing-md">
          ...
          {compare.error && (
            <Card className="border-red-500/40 bg-red-50/50 p-spacing-sm text-sm text-red-700 dark:bg-red-950/20 dark:text-red-300">
              ...
              <div className="max-h-80 overflow-auto">
                <table className="w-full text-sm">
                  <thead className="sticky top-0 bg-background text-left text-xs uppercase text-muted-foreground">
                    <tr>
                      <th className="py-spacing-xs pr-3">Cap.</th>
                      <th className="py-spacing-xs pr-3">Chamadas</th>
                      <th className="py-spacing-xs pr-3">Hit</th>
                      <th className="py-spacing-xs pr-3">Miss</th>
                      <th className="py-spacing-xs pr-3">Stale</th>
                      <th className="py-spacing-xs pr-3">avg (ms)</th>
                      <th className="py-spacing-xs pr-3">p95 (ms)</th>
                      <th className="py-spacing-xs pr-3">max (ms)</th>
                      <th className="py-spacing-xs pr-3">Bolls calls</th>
                      <th className="py-spacing-xs pr-3">Bolls falhas</th>
                  ...
                  <tbody>
                    {drilldown.data!.rows.map((r) => (
                      <tr key={r.chapter} className="border-t border-border/40">
                        ...
                        <td className="py-spacing-xs pr-3">{Number(r.total)}</td>
                        <td className="py-spacing-xs pr-3">{Number(r.hits)}</td>
  ...
  return (
    <table className="w-full text-sm">
      <thead className="text-left text-xs uppercase text-muted-foreground">
        <tr>
          <th className="py-spacing-xs pr-3">Livro</th>
          <th className="py-spacing-xs pr-3">Calls A→B</th>
          <th className="py-spacing-xs pr-3">Hit rate A→B (Δ)</th>
          <th className="py-spacing-xs pr-3">p95 A→B (Δ ms)</th>
          <th className="py-spacing-xs pr-3">Bolls A→B (Δ)</th>
        </tr>
      </thead>
      <tbody>
        {rows.map((r) => (
      ...
      <table className="w-full text-sm">
        <thead className="sticky top-0 bg-background text-left text-xs uppercase text-muted-foreground">
          <tr>
            <th className="py-spacing-xs pr-3">Cap.</th>
            <th className="py-spacing-xs pr-3">Calls A→B</th>
            <th className="py-spacing-xs pr-3">Hit rate (Δ)</th>
            <th className="py-spacing-xs pr-3">p95 (Δ ms)</th>
            <th className="py-spacing-xs pr-3">Bolls (Δ)</th>
          </tr>
        </thead>
        <tbody>
          {rows.map((r) => (
