    ...
    <div className="min-h-screen bg-background text-foreground transition-colors duration-1000">
      ...
      <main className="app-container py-spacing-4xl md:py-spacing-4xl flex flex-col items-center">
        <header className="text-center space-y-spacing-xl mb-spacing-3xl md:mb-spacing-4xl max-w-spacing-2xl mx-auto">
          <div className="inline-flex items-center gap-spacing-md px-spacing-lg py-spacing-xs bg-primary/[0.01] border border-border/10 rounded-full text-[10px] font-black uppercase tracking-[0.5em] text-primary/40">
            <div className="w-spacing-2xs h-spacing-2xs rounded-full bg-primary animate-pulse" />
            Experiência Guiada
          </div>
