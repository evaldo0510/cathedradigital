...
const THEMES: ThemeDescriptor[] = [
  {
    ...
    composedStudy: [
      ...
      { stage: 'fathers',     label: 'Santo Agostinho — De Spe',        hint: 'A esperança como âncora da alma',
        targetPath: RouteRegistry.resolve('study.father', { slug: 'santo-agostinho' }), action: 'open-profile' },
      { stage: 'saints',      label: 'Santa Teresa de Ávila',           hint: 'Testemunho de vida em esperança',
        targetPath: RouteRegistry.resolve('study.saint', { slug: 'santa-teresa-de-avila' }), action: 'open-profile' },
  ...
  },
  {
    ...
    composedStudy: [
      ...
      { stage: 'fathers',     label: 'São João Crisóstomo',             hint: 'Homilias sobre a Eucaristia',
        targetPath: RouteRegistry.resolve('study.father', { slug: 'sao-joao-crisostomo' }), action: 'open-profile' },
      { stage: 'saints',      label: 'Santo Tomás de Aquino',           hint: 'Adoro te devote e a doutrina eucarística',
        targetPath: RouteRegistry.resolve('study.saint', { slug: 'santo-tomas-de-aquino' }), action: 'open-profile' },
  ...
  },
  {
    ...
    composedStudy: [
      ...
      { stage: 'saints',      label: 'Santa Teresinha do Menino Jesus',
        targetPath: RouteRegistry.resolve('study.saint', { slug: 'santa-teresinha' }), action: 'open-profile' },
