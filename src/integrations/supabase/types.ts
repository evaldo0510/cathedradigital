...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      glossary_doctrinal_area: {
        Args: { _category: string; _slug: string }
        Returns: string
      }
      glossary_doctrinal_coverage: {
        Args: never
        Returns: {
          area: string
          avg_ice: number
      ...
      prayers_doctrinal_area: { Args: { _category: string }; Returns: string }
      prayers_doctrinal_coverage: {
        Args: never
        Returns: {
          area: string
          avg_ice: number
      ...
      prayers_quality_gate: { Args: { _slug: string }; Returns: boolean }
