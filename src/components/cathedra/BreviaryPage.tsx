...
const HoraDetail: React.FC<{ hora: HoraInfo; onBack: () => void }> = ({ hora, onBack }) => (
  <div className="max-w-3xl mx-auto space-y-6">
    ...
    <div className="bg-card border border-border rounded-premium p-6 md:p-10 space-y-8">
      {/* Opening */}
      ...
      <div className="space-y-3">
        ...
        <div className="bg-secondary/50 rounded-premium p-5 border border-border">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          {hora.psalms.map((psalm, i) => (
            <div key={i} className="bg-secondary/30 rounded-premium p-5 border border-border">
      ...
      {hora.reading && (
        <div className="space-y-3">
          ...
          <div className="bg-primary/5 rounded-premium p-5 border border-primary/10">
