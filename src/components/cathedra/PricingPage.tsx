    ...
    <div className="min-h-screen pb-24">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto mb-16">
        ...
        <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={0}>
          <Card className="h-full rounded-full border-border/50 bg-card shadow-lg">
        ...
        <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={1}>
          <Card className="h-full rounded-full border-primary/30 bg-card shadow-xl ring-2 ring-primary/10 relative overflow-hidden">
      ...
      <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="max-w-3xl mx-auto">
        ...
        <div className="rounded-full border border-border/50 overflow-hidden bg-card shadow-sm">
      ...
      {/* Mission note */}
      <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="max-w-2xl mx-auto mt-16 text-center space-y-4 p-8 rounded-full bg-primary/5 border border-primary/10">
