    ...
    <div className="min-h-screen pb-24">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto mb-16">
        ...
        <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={0}>
          <Card className="h-full rounded-premium border-border/50 bg-card shadow-lg">
            <CardHeader className="text-center pb-2 space-y-4">
              <div className="w-14 h-14 mx-auto rounded-premium bg-muted flex items-center justify-center">
        ...
        <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={1}>
          <Card className="h-full rounded-premium border-primary/30 bg-card shadow-premium-hover ring-2 ring-primary/10 relative overflow-hidden">
            ...
            <CardHeader className="text-center pb-2 space-y-4">
              <div className="w-14 h-14 mx-auto rounded-premium bg-primary/10 flex items-center justify-center">
      ...
      <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="max-w-3xl mx-auto">
        ...
        <div className="rounded-premium border border-border/50 overflow-hidden bg-card shadow-sm">
      ...
      {/* Mission note */}
      <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="max-w-2xl mx-auto mt-16 text-center space-y-4 p-8 rounded-premium bg-primary/5 border border-primary/10">
