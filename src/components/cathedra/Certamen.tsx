  ...
  if (showResult) {
    ...
    return (
      <div className="max-w-2xl mx-auto space-y-8 p-4">
        <div className="bg-card border border-border rounded-premium-sm p-10 text-center space-y-6 shadow-premium">
          <div className="w-20 h-20 rounded-premium-sm bg-primary/10 flex items-center justify-center mx-auto text-primary">
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 p-4">
      ...
      <div className="flex flex-wrap gap-2 justify-center">
        {CATEGORIES.map(cat => (
          <Button key={cat} onClick={() => { setCategory(cat); restart(); }}
            className={`px-4 py-2 rounded-full text-xs font-bold transition-all ${cat === category ? 'bg-foreground text-background shadow-soft scale-105' : 'bg-card border border-border text-foreground hover:bg-primary/5'}`}>
            {cat}
          </Button>
        ))}
      </div>
      ...
      <div className="flex items-center justify-between text-sm px-2">
        ...
        <div className="h-2 flex-1 mx-4 bg-muted rounded-premium-sm overflow-hidden">
          <motion.div 
            initial={{ width: 0 }}
      ...
      <div className="bg-card border border-border rounded-premium-sm p-8 space-y-6 shadow-sm">
