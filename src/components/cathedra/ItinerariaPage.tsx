      ...
      <div className="app-container py-12 md:py-24 space-y-16 md:space-y-32">
        ...
        >
          <div className="inline-flex items-center gap-3 px-5 py-2 bg-primary/[0.03] rounded-full border border-primary/10 mb-2">
            <Icons.Compass className="w-4 h-4 text-primary" />
              ...
              >
                ...
                >
                  <div className="absolute top-0 right-0 p-8 opacity-[0.03] group-hover:opacity-[0.08] transition-opacity duration-1000">
                    <Icons.Compass className="w-32 h-32 text-primary" />
                  </div>
                  
                  <CardContent className="p-8 md:p-12 space-y-6 relative z-10">
                    <div className="flex items-center gap-3">
                      <Badge variant="outline" className="text-[9px] font-black uppercase tracking-[0.2em] px-3 py-1 bg-primary/5 border-primary/10 text-primary">
                        {item.category}
                      </Badge>
                    ...
                    <div className="pt-8 flex items-center justify-between">
                      ...
                      <div className="w-12 h-12 rounded-full bg-primary/5 border border-primary/10 flex items-center justify-center group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-500">
