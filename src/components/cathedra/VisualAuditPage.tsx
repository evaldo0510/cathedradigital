    ...
    <div className="max-w-7xl mx-auto p-spacing-lg space-y-spacing-xl animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-spacing-md">
        <div>
          ...
          <h1 className="text-3xl font-black tracking-tight flex items-center gap-spacing-sm">
        ...
        <div className="flex items-center gap-spacing-sm">
          <Badge className={`px-spacing-md py-spacing-2xs rounded-full text-[10px] font-black uppercase tracking-widest ${
          ...
          <div className="space-y-spacing-md pt-spacing-md border-t border-border/10">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-muted/20 border border-border/10 rounded-sm py-spacing-xs pl-spacing-xl pr-spacing-md text-sm outline-none focus:border-primary/50"
                value={filter}
                    ...
                    {violations.map((v, i) => (
                      <div key={i} className="p-spacing-md flex items-start justify-between group hover:bg-primary/5 transition-colors">
                        ...
                        <CathedraButton 
                          variant="ghost" 
                          size="sm" 
                          className="opacity-0 group-hover:opacity-100 h-spacing-xl rounded-full text-[9px] font-black uppercase"
                          onClick={() => {
