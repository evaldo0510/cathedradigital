...
export const TagBubble: React.FC<TagBubbleProps> = ({ tag, index, isSuggested, tabIndex, onKeyDown, className, profileId, navigateOnClick, priorityGroup, size }) => {
  ...
  return (
    <Popover open={navigateOnClick ? false : open} onOpenChange={(val) => {
      ...
      <PopoverContent data-testid="nexus-popover" className="w-[340px] sm:w-[460px] p-0 rounded-[3rem] border-primary/10 overflow-hidden shadow-premium z-[100] bg-card/95 backdrop-blur-xl">
        <div className="bg-gradient-to-b from-primary/[0.03] to-transparent p-8 border-b border-border/20 flex items-center justify-between">
          ...
          <Button 
            ...
            className="w-12 h-12 rounded-full bg-primary text-primary-foreground hover:scale-110 active:scale-95 transition-all flex items-center justify-center shadow-premium shadow-primary/10 group border-none"
        ...
        <div className="p-5 space-y-5 max-h-[450px] overflow-y-auto scrollbar-none">
          ...
          <div className="p-2 rounded-premium-sm bg-muted/30 border border-border/40 flex items-center justify-between text-premium-tiny font-black uppercase tracking-widest opacity-60">
          ...
          {status === 'loading' ? (
            <div className="space-y-4 py-2">
              <div className="flex gap-2">
                <div className="w-8 h-8 rounded-premium-sm bg-muted animate-pulse" />
                <div className="flex-1 space-y-2">
                  <div className="h-3 bg-muted rounded animate-pulse w-full" />
                  <div className="h-3 bg-muted rounded animate-pulse w-2/3" />
                </div>
              </div>
              <div className="h-32 bg-muted/20 rounded-premium-sm animate-pulse w-full" />
            ...
            <div className="p-6 text-center space-y-3 bg-red-500/5 rounded-premium-sm border border-red-500/10">
            ...
            <>
              {status === 'error' && content.length > 0 && (
                <div className="px-3 py-1 bg-amber-500/10 text-amber-600 rounded-premium-sm text-premium-tiny font-bold flex items-center gap-2 mb-2">
              ...
              {logosInsight && (
                ...
                >
                  <div className="absolute top-0 right-0 w-16 h-16 bg-secondary/5 rounded-premium-sm  -mr-6 -mt-6" />
              ...
              {content.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-10 text-center space-y-4">
                  <div className="w-16 h-16 rounded-premium-sm bg-muted/20 flex items-center justify-center relative">
                    <div className="absolute inset-0 rounded-premium-sm border border-primary/10 animate-ping opacity-20" />
          ...
          {searchQuery || activeFilter !== 'all' ? (
            ...
            <div key="default" className="space-y-6">
              ...
              {profileId && profileSuggestedTags.length > 0 && (
                ...
                >
                  <div className="absolute top-0 right-0 w-24 h-24 bg-secondary/5 rounded-premium-sm  -mr-8 -mt-8" />
                  <div className="flex items-center gap-2">
                    <div className="w-5 h-5 rounded-premium-sm bg-secondary/20 flex items-center justify-center">
