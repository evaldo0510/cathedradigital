...
const NEXUS_THEMES = [
  ...
  { label: 'Humildade', emoji: '🌿', slug: 'humildade' },
  { label: 'Santidade', emoji: '✨', slug: 'santidade' },
  { label: 'Sofrimento', emoji: '⚔️', slug: 'sofrimento' },
  { label: 'Vocação', emoji: '🔥', slug: 'vocacao' },
  { label: 'Caridade', emoji: '🫶', slug: 'caridade' },
  { label: 'Missão', emoji: '🌍', slug: 'missao' },
  { label: 'Oração', emoji: '🙏', slug: 'oracao' },
  { label: 'Graça', emoji: '💧', slug: 'graca' },
  { label: 'Eucaristia', emoji: '🍞', slug: 'eucaristia' },
  { label: 'Maria', emoji: '🌹', slug: 'maria' },
  { label: 'Justiça', emoji: '⚖️', slug: 'justica' },
];
