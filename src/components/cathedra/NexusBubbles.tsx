      ...
      <PopoverContent data-testid="nexus-popover" className="w-[340px] sm:w-[420px] p-0 rounded-[2.5rem] border-primary/20 overflow-hidden shadow-2xl z-[100]  bg-card">
        <div className="bg-gradient-to-r from-primary/15 via-primary/5 to-transparent p-6 border-b border-border/40 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-full bg-white/50 dark:bg-black/20 flex items-center justify-center shadow-inner text-primary border border-primary/10">
        ...
        <div className="p-5 space-y-5 max-h-[450px] overflow-y-auto scrollbar-none">
          ...
          <div className="p-2 rounded-full bg-muted/30 border border-border/40 flex items-center justify-between text-[8px] font-black uppercase tracking-widest opacity-60">
          ...
          {status === 'loading' ? (
            <div className="space-y-4 py-2">
              ...
              <div className="h-32 bg-muted/20 rounded-full animate-pulse w-full" />
              <p className="text-[10px] text-center text-muted-foreground animate-pulse">Consultando Nexus...</p>
            </div>
          ) : status === 'error' && content.length === 0 ? (
            <div className="p-6 text-center space-y-3 bg-red-500/5 rounded-full border border-red-500/10">
            ...
            <>
              {status === 'error' && content.length > 0 && (
                <div className="px-3 py-1 bg-amber-500/10 text-amber-600 rounded-full text-[9px] font-bold flex items-center gap-2 mb-2">
