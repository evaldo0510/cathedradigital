...
>(({ className, as: Component = "div", href, ...props }, ref) => {
  ...
  return (
    <CathedraCard
      ...
      padding="none"
      className={cn(
        "text-card-foreground focus-within:ring-2 focus-within:ring-primary/20 focus-within:ring-offset-2 focus-within:border-primary/20 outline-none focus-visible:ring-primary/40 focus-visible:ring-offset-2",
        className
      )}
      {...props}
    />
