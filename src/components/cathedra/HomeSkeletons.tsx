  ...
  <div className="w-full py-12 animate-in fade-in duration-500">
    <div className="max-w-7xl mx-auto px-4 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[1, 2, 3].map((i) => (
          <div key={i} className="h-64 bg-muted/10 rounded-3xl border border-border/50 animate-pulse" />
        ))}
      </div>
    </div>
  </div>
...
export const RitualSkeleton = () => (
  <div className="w-full rounded-3xl border border-border bg-card/50 p-6 space-y-6 animate-pulse">
...
export const HeroSkeleton = () => (
  <div className="w-full min-h-[80vh] flex flex-col items-center justify-center p-6 space-y-8 animate-in fade-in duration-700">
    ...
    <div className="space-y-4 items-center flex flex-col">
      ...
      <div className="h-6 w-48 md:w-64 bg-muted/10 rounded-xl" />
    </div>
