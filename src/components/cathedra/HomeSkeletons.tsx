...
export const RitualSkeleton = () => (
  <div className="w-full rounded-premium border border-primary/5 bg-card/50 p-6 space-y-6 animate-pulse">
    ...
    <div className="space-y-3">
      <div className="h-4 w-full bg-muted/20 rounded-premium" />
      <div className="h-4 w-3/4 bg-muted/20 rounded-premium" />
    </div>
  </div>
);
...
export const HeroSkeleton = () => (
  <div className="w-full min-h-[80vh] flex flex-col items-center justify-center p-6 space-y-8 animate-in fade-in duration-700">
    ...
    <div className="flex gap-4">
      <div className="h-14 w-40 bg-muted/20 rounded-premium" />
      <div className="h-14 w-40 bg-muted/10 rounded-premium" />
    </div>
  </div>
);
