...
const CatechismContent: React.FC<{ paragraph: number; onNavigateToBible?: (abbr: string, chapter: number) => void; isVisible?: boolean }> = ({ paragraph, onNavigateToBible, isVisible = true }) => {
  ...
  if (isError) {
    ...
    return (
      <div className="reader-text bg-destructive/5 border border-destructive/10 rounded-full p-4 text-destructive font-serif text-sm py-4 space-y-2">
  ...
  if (data?.status === 'error_402') {
    return (
      <div className="reader-text bg-amber-500/5 border border-amber-500/10 rounded-full p-4 text-amber-600 dark:text-amber-400 font-serif text-sm py-4 space-y-3">
        <div className="font-bold flex items-center gap-2">
    ...
    return (
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-3 justify-center">
          ...
          <div className="px-4 py-2 bg-primary/5 border border-primary/20 rounded-full text-xs font-black uppercase tracking-widest text-primary">
        ...
        <div className="bg-card border border-border rounded-full p-6 md:p-10 space-y-12">
