...
const QUESTIONS: QuizQuestion[] = [
  {
    ...
    options: [
      { label: 'Pesado, cansado por dentro', value: 'pesado', icon: <Heart className="w-md h-md" />, weight: { ferido_em_busca: 4, ansioso_buscador: 2, sedento_de_sentido: 0, firme_aprofundando: 0, ardente_missionario: 0 } },
      { label: 'Inquieto, procurando algo', value: 'inquieto', icon: <Wind className="w-md h-md" />, weight: { ferido_em_busca: 1, ansioso_buscador: 1, sedento_de_sentido: 4, firme_aprofundando: 0, ardente_missionario: 0 } },
      { label: 'Estável, mas querendo mais', value: 'estavel', icon: <Anchor className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 0, sedento_de_sentido: 1, firme_aprofundando: 4, ardente_missionario: 1 } },
      { label: 'Aceso, pronto para agir', value: 'aceso', icon: <Flame className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 0, sedento_de_sentido: 0, firme_aprofundando: 1, ardente_missionario: 4 } },
    ],
  },
  {
    id: 'dor',
    ...
    options: [
      { label: 'Ansiedade ou medo do futuro', value: 'ansiedade', icon: <Wind className="w-md h-md" />, weight: { ferido_em_busca: 4, ansioso_buscador: 2, sedento_de_sentido: 1, firme_aprofundando: 0, ardente_missionario: 0 } },
      { label: 'Culpa, remorso ou mágoas', value: 'culpa', icon: <Heart className="w-md h-md" />, weight: { ferido_em_busca: 1, ansioso_buscador: 4, sedento_de_sentido: 1, firme_aprofundando: 0, ardente_missionario: 0 } },
      { label: 'Vazio, falta de propósito', value: 'vazio', icon: <Eye className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 1, sedento_de_sentido: 4, firme_aprofundando: 0, ardente_missionario: 0 } },
      { label: 'Desejo de fazer mais por Deus', value: 'chamado', icon: <Flame className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 0, sedento_de_sentido: 0, firme_aprofundando: 2, ardente_missionario: 4 } },
    ],
  },
  {
    id: 'conhecimento',
    ...
    options: [
      { label: 'Estou começando agora', value: 'iniciante', icon: <BookOpen className="w-md h-md" />, weight: { ferido_em_busca: 3, ansioso_buscador: 3, sedento_de_sentido: 1, firme_aprofundando: 0, ardente_missionario: 0 } },
      { label: 'Conheço o básico, mas quero mais', value: 'medio', icon: <Brain className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 1, sedento_de_sentido: 3, firme_aprofundando: 1, ardente_missionario: 0 } },
      { label: 'Tenho uma boa base doutrinária', value: 'avancado', icon: <Shield className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 0, sedento_de_sentido: 1, firme_aprofundando: 4, ardente_missionario: 1 } },
      { label: 'Estudo profundamente há anos', value: 'mestre', icon: <Sparkles className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 0, sedento_de_sentido: 0, firme_aprofundando: 1, ardente_missionario: 4 } },
    ],
  },
  {
    id: 'oracao',
    ...
    options: [
      { label: 'Quase não rezo', value: 'raro', icon: <Sun className="w-md h-md" />, weight: { ferido_em_busca: 3, ansioso_buscador: 1, sedento_de_sentido: 2, firme_aprofundando: 0, ardente_missionario: 0 } },
      { label: 'Rezo nos momentos difíceis', value: 'crise', icon: <Shield className="w-md h-md" />, weight: { ferido_em_busca: 1, ansioso_buscador: 3, sedento_de_sentido: 1, firme_aprofundando: 0, ardente_missionario: 0 } },
      { label: 'Tenho tentado criar uma rotina', value: 'rotina', icon: <Sparkles className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 0, sedento_de_sentido: 2, firme_aprofundando: 3, ardente_missionario: 0 } },
      { label: 'Rezo diariamente com profundidade', value: 'profunda', icon: <Flame className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 0, sedento_de_sentido: 0, firme_aprofundando: 1, ardente_missionario: 3 } },
    ],
  },
  {
    id: 'tempo',
    ...
    options: [
      { label: 'Menos de 15 minutos', value: 'pouco', icon: <Clock className="w-md h-md" />, weight: { ferido_em_busca: 3, ansioso_buscador: 3, sedento_de_sentido: 1, firme_aprofundando: 0, ardente_missionario: 0 } },
      { label: 'Entre 15 e 30 minutos', value: 'medio', icon: <Clock className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 1, sedento_de_sentido: 3, firme_aprofundando: 2, ardente_missionario: 0 } },
      { label: 'Mais de 30 minutos', value: 'muito', icon: <Clock className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 0, sedento_de_sentido: 1, firme_aprofundando: 3, ardente_missionario: 2 } },
      { label: 'Vivo em constante oração', value: 'contemplativo', icon: <Flame className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 0, sedento_de_sentido: 0, firme_aprofundando: 1, ardente_missionario: 4 } },
    ],
  },
  {
    id: 'sacramento',
    ...
    options: [
      { label: 'Fui batizado mas não pratico', value: 'batizado', icon: <Church className="w-md h-md" />, weight: { ferido_em_busca: 3, ansioso_buscador: 2, sedento_de_sentido: 1, firme_aprofundando: 0, ardente_missionario: 0 } },
      { label: 'Vou à Missa quando posso', value: 'eventual', icon: <Church className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 1, sedento_de_sentido: 3, firme_aprofundando: 1, ardente_missionario: 0 } },
      { label: 'Missa semanal e confissão regular', value: 'regular', icon: <Sparkles className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 0, sedento_de_sentido: 0, firme_aprofundando: 3, ardente_missionario: 1 } },
      { label: 'Vida sacramental intensa e diária', value: 'intensa', icon: <Flame className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 0, sedento_de_sentido: 0, firme_aprofundando: 1, ardente_missionario: 3 } },
    ],
  },
  {
    id: 'obstaculo',
    ...
    options: [
      { label: 'Cansaço ou esgotamento mental', value: 'cansaco', icon: <Wind className="w-md h-md" />, weight: { ferido_em_busca: 4, ansioso_buscador: 1, sedento_de_sentido: 0, firme_aprofundando: 0, ardente_missionario: 0 } },
      { label: 'Falta de tempo e correria', value: 'tempo', icon: <Clock className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 4, sedento_de_sentido: 1, firme_aprofundando: 0, ardente_missionario: 0 } },
      { label: 'Falta de foco ou preguiça', value: 'foco', icon: <Brain className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 0, sedento_de_sentido: 2, firme_aprofundando: 3, ardente_missionario: 0 } },
      { label: 'Sentir-se sozinho na caminhada', value: 'solidao', icon: <Users className="w-md h-md" />, weight: { ferido_em_busca: 1, ansioso_buscador: 0, sedento_de_sentido: 2, firme_aprofundando: 0, ardente_missionario: 3 } },
    ],
  },
  {
    id: 'comunidade',
    ...
    options: [
      { label: 'Não participo de nenhum grupo', value: 'sozinho', icon: <Sun className="w-md h-md" />, weight: { ferido_em_busca: 3, ansioso_buscador: 2, sedento_de_sentido: 1, firme_aprofundando: 0, ardente_missionario: 0 } },
      { label: 'Gostaria, mas não sei como', value: 'desejo', icon: <Heart className="w-md h-md" />, weight: { ferido_em_busca: 1, ansioso_buscador: 2, sedento_de_sentido: 3, firme_aprofundando: 0, ardente_missionario: 0 } },
      { label: 'Participo de um grupo ou pastoral', value: 'ativo', icon: <Users className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 0, sedento_de_sentido: 0, firme_aprofundando: 3, ardente_missionario: 1 } },
      { label: 'Lidero ou sirvo ativamente', value: 'lider', icon: <Flame className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 0, sedento_de_sentido: 0, firme_aprofundando: 0, ardente_missionario: 3 } },
    ],
  },
  {
    id: 'desejo',
    ...
    options: [
      { label: 'Paz, silêncio interior', value: 'paz', icon: <Mountain className="w-md h-md" />, weight: { ferido_em_busca: 4, ansioso_buscador: 1, sedento_de_sentido: 1, firme_aprofundando: 0, ardente_missionario: 0 } },
      { label: 'Cura, libertação de algo', value: 'cura', icon: <Heart className="w-md h-md" />, weight: { ferido_em_busca: 1, ansioso_buscador: 4, sedento_de_sentido: 0, firme_aprofundando: 0, ardente_missionario: 0 } },
      { label: 'Sentido, propósito claro', value: 'sentido', icon: <Eye className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 1, sedento_de_sentido: 4, firme_aprofundando: 1, ardente_missionario: 0 } },
      { label: 'Servir, fazer diferença', value: 'servir', icon: <Flame className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 0, sedento_de_sentido: 0, firme_aprofundando: 1, ardente_missionario: 4 } },
    ],
  },
  {
    id: 'passo',
    ...
    options: [
      { label: 'Parar, respirar e acolher a dor', value: 'parar', icon: <Mountain className="w-md h-md" />, weight: { ferido_em_busca: 4, ansioso_buscador: 2, sedento_de_sentido: 0, firme_aprofundando: 0, ardente_missionario: 0 } },
      { label: 'Entender melhor a fé católica', value: 'entender', icon: <BookOpen className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 1, sedento_de_sentido: 4, firme_aprofundando: 1, ardente_missionario: 0 } },
      { label: 'Aprofundar na vida espiritual', value: 'aprofundar', icon: <Sparkles className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 0, sedento_de_sentido: 1, firme_aprofundando: 4, ardente_missionario: 1 } },
      { label: 'Evangelizar e servir na missão', value: 'missao', icon: <Flame className="w-md h-md" />, weight: { ferido_em_busca: 0, ansioso_buscador: 0, sedento_de_sentido: 0, firme_aprofundando: 0, ardente_missionario: 4 } },
    ],
  },
];
...
const SpiritualQuiz: React.FC = () => {
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="rounded-premium border border-border bg-card p-md space-y-3">
        ...
        <div className="flex items-center gap-sm">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-premium-small text-muted-foreground mt-3xs">💔 {painLabel} · 🔥 {dirLabel}</p>
          </div>
        </div>
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex items-center gap-xs px-sm py-xs rounded-premium bg-primary/[0.04] border border-primary/10">
              <BookOpen className="w-md h-md text-primary shrink-0" />
              <span className="text-foreground/80">Tema: <strong className="text-foreground">{p.theme}</strong></span>
            </div>
            <div className="flex items-center gap-xs px-sm py-xs rounded-premium bg-secondary/[0.06] border border-secondary/10">
              <Brain className="w-md h-md text-secondary shrink-0" />
        ...
        <div className="flex flex-col gap-sm">
          <Button onClick={() => navigate(AppRoute.JORNADAS)} className="rounded-full h-2xl gap-xs font-bold text-xs uppercase tracking-widest bg-primary text-primary-foreground">
            <Sparkles className="w-md h-md" /> Começar agora
          </Button>
          <Button variant="outline" onClick={() => navigate(AppRoute.STUDY_MODE)} className="rounded-full h-xl gap-xs text-xs font-bold border-secondary/30 text-secondary hover:bg-secondary/5">
            <Brain className="w-md h-md" /> Refletir com Logos
          </Button>
  ...
  if (phase === 'intro') {
    return (
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2xs text-muted-foreground">
          <Clock className="w-sm h-sm" />
          <span className="text-premium-small font-medium">Leva menos de 2 minutos</span>
        </div>
        <Button
          onClick={() => setPhase('quiz')}
          className="w-full rounded-full h-2xl gap-xs font-bold text-xs uppercase tracking-widest bg-secondary text-secondary-foreground hover:bg-secondary/90"
        >
          Começar <ArrowRight className="w-md h-md" />
        </Button>
      </motion.div>
    );
  }
  ...
  return (
    ...
    >
          ...
          <div className="space-y-2.5" role="radiogroup" aria-label={q.question}>
            {q.options.map((opt) => (
              <motion.button
                ...
                className="w-full flex items-center gap-sm p-sm rounded-full border border-border bg-card hover:border-secondary/40 hover:bg-secondary/5 transition-all text-left group focus-visible:ring-2 focus-visible:ring-secondary outline-none"
              >
      ...
      {step > 0 && (
        <Button onClick={() => setStep(s => s - 1)} className="flex items-center gap-2xs text-xs text-muted-foreground hover:text-foreground transition-colors">
          <ArrowLeft className="w-sm h-sm" /> Voltar
        </Button>
      )}
    </motion.div>
  );
