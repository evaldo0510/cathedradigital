...
const SpiritualQuiz: React.FC = () => {
  ...
  if (done && existing && PROFILES[existing]) {
    ...
    return (
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="rounded-premium-sm border border-border bg-card p-5 space-y-3">
    ...
    return (
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="p-3 rounded-premium-sm bg-background/60 border border-border space-y-1 text-center">
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-center gap-2 px-3 py-2.5 rounded-premium-sm bg-primary/[0.04] border border-primary/10">
  ...
  return (
    ...
    >
      <div className="space-y-1">
        ...
        <div className="h-1.5 bg-muted rounded-premium-sm overflow-hidden">
          <motion.div className="h-full bg-secondary rounded-premium-sm" animate={{ width: `${progress}%` }} transition={{ type: 'spring', damping: 20 }} />
        </div>
      </div>
