        ...
        <div className="app-container flex items-center justify-between h-14 md:h-36 py-1 md:py-0">
          ...
          >
            ...
            <div className="flex flex-col items-start min-w-0">
              <span className="text-[10px] md:text-2xl font-display font-light uppercase tracking-[0.4em] md:tracking-[0.8em] text-primary/60 leading-none transition-premium-slow group-hover:text-primary">
