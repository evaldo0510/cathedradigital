    ...
    <header className="border-b border-border/10 bg-background/80 backdrop-blur-2xl sticky top-0 z-[140] transition-all pt-[env(safe-area-inset-top,0px)]">
      <div className="app-container flex items-center justify-between h-20 sm:h-24">
        ...
        <div className="flex items-center gap-1.5 sm:gap-4 flex-shrink-0 app-header-actions">
          ...
          {showNotifs && user && (
            <div className="absolute top-full right-4 mt-4 w-80 bg-card border border-border rounded-premium shadow-2xl z-[150] overflow-hidden animate-in fade-in zoom-in duration-300">
