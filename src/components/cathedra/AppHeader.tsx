...
const AppHeader: React.FC<AppHeaderProps> = React.memo(({
  ...
  return (
    <>
      <header 
        className="bg-background/0.1 backdrop-blur-3xl sticky top-0 z-[140] transition-all duration-[2500ms] pt-[env(safe-area-inset-top,0px)] will-change-[transform,opacity] admin-hide header-reading-auto-hide border-b border-primary/[0.00005]"
        role="banner"
      >
