...
const AppHeader: React.FC<AppHeaderProps> = React.memo(({
  ...
  return (
    <header className="border-b border-primary/5 bg-background/60 backdrop-blur-2xl sticky top-0 z-[140] transition-all duration-500 pt-[env(safe-area-inset-top,0px)] hover:bg-background/80 md:hidden">
