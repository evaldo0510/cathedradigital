  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80dvh] p-6 text-center space-y-8 animate-in fade-in duration-700">
      ...
      <div className="relative">
        <div className="w-32 h-32 rounded-premium-sm bg-primary/5 flex items-center justify-center border border-primary/10">
      ...
      <div className="max-w-md space-y-4">
        ...
        {stats && stats.total > 0 && (
          <div className="flex flex-col items-center gap-2 pt-2 animate-in fade-in slide-in-from-top-1 duration-1000">
            <div className="flex items-center gap-2 text-premium-tiny font-black uppercase tracking-widest text-primary bg-primary/5 px-4 py-2 rounded-premium-sm border border-primary/10">
