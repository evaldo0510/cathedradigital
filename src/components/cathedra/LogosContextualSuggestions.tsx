...
export const LogosContextualSuggestions: React.FC<LogosContextualSuggestionsProps> = ({
  ...
  const suggestions: Suggestion[] = [
    {
      ...
      icon: <Icons.Sparkles className="w-sm h-sm" strokeWidth={0.5} />
    },
    {
      id: 'connections',
      ...
      icon: <Icons.Compass className="w-sm h-sm" strokeWidth={0.5} />
    },
    {
      id: 'reflection',
      label: 'Via de Oração',
      prompt: `Ofereça uma reflexão silenciosa e meditativa para auxiliar minha oração baseada neste texto: ${context}`,
      icon: <Icons.Feather className="w-sm h-sm" strokeWidth={0.5} />
    }
  ];
  ...
  return (
    <div className="mt-4xl py-2xl border-t border-primary/5">
      <div className="flex items-center gap-md mb-xl opacity-30">
        <div className="w-px h-2xl bg-gradient-to-b from-transparent via-primary to-transparent" />
      ...
      <div className="flex flex-wrap gap-md">
        {suggestions.map((suggestion) => (
          <motion.button
            ...
            className="flex items-center gap-md px-lg py-md rounded-premium bg-primary/[0.01] border border-primary/[0.03] hover:bg-primary/[0.02] hover:border-primary/10 transition-all group opacity-60"
          >
