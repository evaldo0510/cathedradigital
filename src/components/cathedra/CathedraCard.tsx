  ...
  ({ className, variant = 'default', padding = 'md', hover = false, children, ...props }, ref) => {
    ...
    return (
      <motion.div
        ...
        transition={settings.reduceAnimations ? { duration: 0.1 } : (props.transition || { duration: 2.8, ease: [0.16, 1, 0.3, 1] })}
        whileHover={settings.reduceAnimations ? {} : { y: -5, scale: 1.001, transition: { duration: 1.8, ease: [0.16, 1, 0.3, 1] } }}
        {...props}
      >
        {children}
      </motion.div>
