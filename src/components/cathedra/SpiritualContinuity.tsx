...
const SpiritualContinuity: React.FC<SpiritualContinuityProps> = ({ 
  ...
  return (
    ...
    >
      <CathedraCard variant={variant} padding="none" className="p-4 md:p-12 border-primary/5 bg-primary/[0.005] hover:border-primary/20 transition-all duration-700 relative overflow-hidden group shadow-none">
