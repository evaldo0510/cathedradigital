      ...
      <div className="max-w-3xl mx-auto space-y-6 py-10 px-4">
        ...
        <div className="bg-card border border-border rounded-full p-6 space-y-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-foreground text-background flex items-center justify-center font-black text-sm">
        ...
        <div className="space-y-3">
          {replies.map(r => (
            <div key={r.id} className="bg-card border border-border rounded-full p-4 ml-6">
        ...
        {user ? (
          <div className="bg-card border border-border rounded-full p-4 space-y-3">
            <textarea
              value={replyContent}
    ...
    <div className="desktop-layout py-10">
      ...
      <aside className="desktop-aside space-y-6 hidden xl:block">
        ...
        <div className="desktop-card">
          <h3 className="text-[11px] font-black uppercase tracking-widest text-secondary mb-4">Líderes de Engajamento</h3>
          <div className="space-y-4">
            {leaderboard.slice(0, 3).map((entry, i) => (
              <div key={entry.id} className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[10px] font-bold text-foreground truncate">{entry.name}</p>
                  <p className="text-[8px] text-muted-foreground uppercase font-medium">{entry.levelName}</p>
                </div>
              </div>
            ))}
          </div>
