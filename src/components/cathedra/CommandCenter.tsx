...
const PAGE_COMMANDS: CommandItem[] = [
  ...
  { label: 'Santos', description: 'Hagiografia', path: AppRoute.SAINTS, icon: <Icons.Users className="w-4 h-4" />, keywords: ['santos', 'santo', 'santa', 'hagiografia', 'mártir'], type: 'page' },
  { label: 'Magistério', description: 'Encíclicas e documentos', path: AppRoute.MAGISTERIUM, icon: <Icons.Globe className="w-4 h-4" />, keywords: ['magistério', 'encíclica', 'concílio', 'papa', 'vaticano'], type: 'page' },
  ...
  { label: 'Liturgia Diária', description: 'Leituras do dia', path: AppRoute.DAILY_LITURGY, icon: <Icons.Star className="w-4 h-4" />, keywords: ['liturgia', 'leitura', 'missa', 'evangelho do dia'], type: 'page' },
  ...
  { label: 'Calendário Litúrgico', description: 'Festas e cores litúrgicas', path: AppRoute.LITURGICAL_CALENDAR, icon: <Icons.History className="w-4 h-4" />, keywords: ['calendário', 'litúrgico', 'festas', 'solenidade', 'cores'], type: 'page' },
