  ...
  return (
    <div className="fixed bottom-spacing-4xl right-spacing-lg z-[9999]">
      <Button
        ...
        className="flex items-center gap-spacing-xs px-spacing-md py-spacing-xs bg-primary text-white rounded-premium-full shadow-premium-hover hover:scale-105 transition-all border border-white/20"
      >
        <Icons.Activity className="w-spacing-md h-spacing-md" />
        <span className="text-premium-xs font-black uppercase tracking-widest">Dev Inspector</span>
      </Button>
        ...
        {isOpen && (
          ...
          >
            <div className="p-spacing-md border-b border-border bg-muted/30 flex items-center justify-between">
              <h4 className="text-premium-xs font-black uppercase tracking-widest text-primary flex items-center gap-spacing-xs">
