    ...
    <div className={cn(
      ...
      {(title || subtitle || Icon) && (
        <header className={cn(
          ...
          {subtitle && (
            <p className="text-[8px] md:text-[10px] font-semibold uppercase text-primary/10 mb-sm md:mb-lg tracking-premium-widest md:tracking-[1.2em] transition-all duration-1000">
              {subtitle}
            </p>
          )}
          {title && (
          ...
          {headerActions && (
            <div className="mt-md md:mt-xl w-full flex justify-center">
              {headerActions}
            </div>
          )}
        </header>
