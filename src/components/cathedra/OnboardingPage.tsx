...
const SLIDES = [
  {
    ...
    subtitle: 'Sua vida espiritual em um só lugar',
    description: 'Desenvolvemos um ecossistema completo para nutrir sua fé, integrando oração, estudo, comunidade e acompanhamento diário.',
    image: onboardingBible,
  },
  {
    icon: <Sun className="w-10 h-10" />,
    title: 'Hoje: Seu Guia Diário',
    subtitle: 'O centro da sua rotina',
    description: 'Na aba "Hoje", você encontra a Liturgia do Dia, o Santo do Dia e meditações personalizadas para o seu momento atual.',
    image: onboardingPrayer,
  },
  {
    icon: <BookOpen className="w-10 h-10" />,
    title: 'Biblioteca e Magistério',
    subtitle: 'O Scriptuarium da Verdade',
    description: 'Acesse a Bíblia Sagrada, o Catecismo, as Obras de S. Tomás de Aquino e documentos dos Papas com um clique.',
    image: onboardingBible,
  },
  {
    ...
    description: 'Tire dúvidas teológicas e peça explicações profundas com nossa IA treinada exclusivamente na Tradição da Igreja.',
  ...
  },
  {
    ...
    description: 'Siga trilhas de aprendizado e oração estruturadas para o seu nível, desde o básico até a vida mística profunda.',
    image: onboardingCommunity,
  },
  {
    icon: <Users className="w-10 h-10" />,
    title: 'Aula Magna',
    subtitle: 'Comunidade e Partilha',
    description: 'Interaja com outros fiéis, compartilhe reflexões sobre as leituras do dia e cresça em fraternidade espiritual.',
    image: onboardingCommunity,
  },
];
