...
const HomeMainContent: React.FC<HomeMainContentProps> = React.memo(({ user, profile, onNavigate, t }) => {
  ...
  return (
    <div id="main-content" className="w-full max-w-[var(--layout-max-width)] mx-auto stack-rhythm-lg pb-12 md:pb-[32rem] px-[var(--space-mobile-padding)] md:px-14 lg:px-24 xl:px-32 outline-none flex flex-col items-center sm:items-stretch" tabIndex={-1}>
      ...
      <div className="py-40 md:py-80 flex flex-col items-center gap-6 opacity-5 select-none pointer-events-none">
      ...
      <div className="py-40 md:py-96 flex justify-center opacity-2">
