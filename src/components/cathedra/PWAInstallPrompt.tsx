...
export const PWAInstallPrompt = () => {
  ...
  return (
    <div className="fixed bottom-20 left-4 right-4 md:left-auto md:right-8 md:bottom-8 md:w-80 bg-background border border-primary/20 p-4 rounded-full shadow-2xl z-50 animate-in fade-in slide-in-from-bottom-4 duration-300">
      <button 
