...
const HomeMainDoors: React.FC<HomeMainDoorsProps> = ({ t, className }) => {
  ...
  return (
    <div className={cn("grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[var(--space-mobile-stack)] md:gap-16 lg:gap-24 w-full max-w-7xl mx-auto", className)}>
      {doors.map((door, idx) => (
        <CathedraCard
          key={idx}
          ...
          className="padding-rhythm md:p-24 lg:p-32 flex flex-col items-center text-center gap-6 md:gap-16 focus-visible:ring-primary/40 focus-visible:ring-offset-2 group border-primary/5"
        >
          ...
          <div className="space-y-6">
            <h4 className="text-[10px] font-bold uppercase tracking-[0.4em] text-primary/80 group-hover:text-primary transition-colors duration-700">
              {door.label}
            </h4>
