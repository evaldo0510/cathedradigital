            ...
            >
              ...
              >
                <CardContent className="p-md flex items-center gap-sm">
                  <Icon className="w-lg h-lg text-primary" />
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-semibold text-foreground truncate">{rec.label}</p>
                    <p className="text-xs text-muted-foreground">{rec.reason}</p>
                  </div>
                  <Icons.ChevronRight className="w-md h-md text-muted-foreground group-hover:text-primary transition-colors flex-shrink-0" />
                </CardContent>
              </Card>
            </motion.div>
          );
