  ...
  return (
    <ModalShell title="Documentos — Consulta Rápida" onClose={onClose}>
      ...
      <div className="max-h-[50vh] overflow-y-auto space-y-1">
        {filtered.map(d => (
          <div key={d.title} className="flex items-center justify-between p-3 rounded-full hover:bg-muted transition-colors">
            <div>
...
const ModalShell: React.FC<{ title: string; onClose: () => void; children: React.ReactNode }> = ({ title, onClose, children }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-lg bg-card border border-border rounded-full shadow-2xl p-6 overflow-hidden animate-in zoom-in-95 duration-200" onClick={e => e.stopPropagation()}>
