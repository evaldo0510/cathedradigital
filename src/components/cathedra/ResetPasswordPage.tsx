  ...
  if (!isRecovery) {
    return (
      <div className="max-w-spacing-md mx-auto text-center space-y-spacing-lg py-spacing-3xl">
        {/* Logo removed */}
        <h1 className="text-premium-2xl font-serif font-bold text-foreground">Link inválido</h1>
  ...
  return (
    <div className="max-w-spacing-md mx-auto space-y-spacing-xl py-spacing-3xl">
      <div className="text-center space-y-spacing-md">
        {/* Logo removed */}
        <h1 className="text-premium-3xl font-serif font-bold text-foreground">Nova Senha</h1>
      ...
      <div className="bg-card border border-border rounded-premium p-spacing-xl space-y-spacing-lg">
        ...
        {success ? (
          <div className="p-spacing-md bg-primary/10 border border-primary/20 rounded-premium text-premium-sm text-primary font-medium text-center">
            Senha atualizada com sucesso! Redirecionando...
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-spacing-md">
            <div>
              <label className="text-premium-xs font-black uppercase tracking-widest text-muted-foreground mb-spacing-xs block">Nova Senha</label>
              <input
            ...
            <div>
              <label className="text-premium-xs font-black uppercase tracking-widest text-muted-foreground mb-spacing-xs block">Confirmar Senha</label>
              <input
            ...
            <Button type="submit" disabled={loading}
              className="w-full py-spacing-md bg-foreground text-background rounded-premium-full font-black uppercase text-premium-xs tracking-widest shadow-premium-hover hover:bg-primary hover:text-primary-foreground transition-all disabled:opacity-50">
