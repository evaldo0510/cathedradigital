...
const ResetPasswordPage: React.FC = () => {
  ...
  if (!isRecovery) {
    return (
      <div className="max-w-md mx-auto text-center space-y-6 py-3xl">
        {/* Logo removed */}
  ...
  return (
    <div className="max-w-md mx-auto space-y-8 py-3xl">
      ...
      <div className="bg-card border border-border rounded-premium p-xl space-y-6">
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-premium-tiny font-black uppercase tracking-widest text-muted-foreground mb-xs block">Nova Senha</label>
              <input
            ...
            <div>
              <label className="text-premium-tiny font-black uppercase tracking-widest text-muted-foreground mb-xs block">Confirmar Senha</label>
              <input
            ...
            <Button type="submit" disabled={loading}
              className="w-full py-md bg-foreground text-background rounded-full font-black uppercase text-premium-tiny tracking-widest shadow-premium-hover hover:bg-primary hover:text-primary-foreground transition-all disabled:opacity-50">
