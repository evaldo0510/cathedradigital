  ...
  return (
    <div className="max-w-spacing-4xl mx-auto p-spacing-lg space-y-spacing-xl animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-spacing-md">
        <div>
          <h1 className="text-premium-2xl font-serif font-bold text-foreground">Depuração do Catecismo</h1>
          <p className="text-premium-sm text-muted-foreground">Monitore o estado da geração automática via IA</p>
        </div>
        <div className="flex flex-wrap items-center gap-spacing-xs">
          <Button 
            onClick={loadData}
            disabled={loading}
            className="p-spacing-xs rounded-premium-full bg-card border border-border hover:bg-primary/10 transition-all disabled:opacity-50"
            title="Atualizar"
          >
          ...
          <Button 
            ...
            className="px-spacing-md py-spacing-xs rounded-premium-full bg-primary text-primary-foreground text-premium-xs font-black uppercase tracking-widest hover:brightness-110 transition-all disabled:opacity-50 flex items-center gap-spacing-xs"
          >
          ...
          <Button 
            ...
            className="px-spacing-md py-spacing-xs rounded-premium-full bg-orange-500 text-white text-premium-xs font-black uppercase tracking-widest hover:brightness-110 transition-all disabled:opacity-50 flex items-center gap-spacing-xs shadow-premium-md"
          >
            <Icons.PenTool className="w-spacing-sm h-spacing-sm" /> Reparar Incompletos
          </Button>
          <Button 
            onClick={() => window.location.href = '/catechism/integrity'}
            className="px-spacing-md py-spacing-xs rounded-premium-full bg-blue-500 text-white text-premium-xs font-black uppercase tracking-widest hover:brightness-110 transition-all flex items-center gap-spacing-xs shadow-premium-md"
          >
            <Icons.Activity className="w-spacing-sm h-spacing-sm" /> Painel de Integridade
          </Button>
          <Button 
            onClick={clearInvalidCache}
            className="px-spacing-md py-spacing-xs rounded-premium-full bg-destructive/10 text-destructive text-premium-xs font-black uppercase tracking-widest hover:bg-destructive/20 transition-all flex items-center gap-spacing-xs"
          >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-spacing-md">
        <div className="bg-card border border-border rounded-premium p-spacing-md">
          <span className="text-premium-xs font-black uppercase tracking-widest text-muted-foreground">Total no Banco</span>
          <div className="text-premium-2xl font-serif font-bold text-foreground">{stats.total}</div>
        </div>
        <div className="bg-card border border-border rounded-premium p-spacing-md">
          <span className="text-premium-xs font-black uppercase tracking-widest text-success text-green-500">Gerados OK</span>
          <div className="text-premium-2xl font-serif font-bold text-foreground">{stats.generated}</div>
        </div>
        <div className="bg-card border border-border rounded-premium p-spacing-md">
          <span className="text-premium-xs font-black uppercase tracking-widest text-primary">Pendentes (402)</span>
          <div className="text-premium-2xl font-serif font-bold text-foreground">{stats.pending}</div>
        </div>
        <div className="bg-card border border-border rounded-premium p-spacing-md">
          <span className="text-premium-xs font-black uppercase tracking-widest text-destructive">Inválidos/Curtos</span>
          <div className="text-premium-2xl font-serif font-bold text-foreground">{stats.invalid}</div>
        </div>
      </div>
          ...
          <div className="flex items-center gap-spacing-md">
            <div className="flex items-center gap-spacing-xs bg-background/50 border border-border rounded-premium p-spacing-2xs">
              <Button 
                ...
                className={`px-spacing-sm py-spacing-2xs text-premium-xs font-black uppercase tracking-widest rounded-premium-full transition-all ${view === 'cache' ? 'bg-primary text-primary-foreground shadow-premium-md' : 'text-muted-foreground hover:text-foreground'}`}
              >
                Cache
              </Button>
              <Button 
                onClick={() => setView('logs')}
                className={`px-spacing-sm py-spacing-2xs text-premium-xs font-black uppercase tracking-widest rounded-premium-full transition-all ${view === 'logs' ? 'bg-primary text-primary-foreground shadow-premium-md' : 'text-muted-foreground hover:text-foreground'}`}
              >
                Logs
              </Button>
              <Button 
                onClick={() => setView('integrity')}
                className={`px-spacing-sm py-spacing-2xs text-premium-xs font-black uppercase tracking-widest rounded-premium-full transition-all ${view === 'integrity' ? 'bg-primary text-primary-foreground shadow-premium-md' : 'text-muted-foreground hover:text-foreground'}`}
              >
                Integridade
              </Button>
            </div>
            {view === 'cache' && (
              <div className="flex items-center gap-spacing-xs bg-background/50 border border-border rounded-premium p-spacing-2xs">
                ...
                <Button onClick={() => setFilter('generated')} className={`px-spacing-sm py-spacing-2xs text-premium-xs font-black uppercase tracking-widest rounded-premium-full transition-all ${filter === 'generated' ? 'bg-primary text-primary-foreground shadow-premium-md' : 'text-muted-foreground hover:text-foreground'}`}>Sucesso</Button>
                <Button onClick={() => setFilter('error')} className={`px-spacing-sm py-spacing-2xs text-premium-xs font-black uppercase tracking-widest rounded-premium-full transition-all ${filter === 'error' ? 'bg-primary text-primary-foreground shadow-premium-md' : 'text-muted-foreground hover:text-foreground'}`}>Erros</Button>
              </div>
            )}
            {view === 'integrity' && (
              <div className="flex items-center gap-spacing-xs">
                <Button 
                  ...
                  className="p-spacing-xs rounded-premium-full bg-primary/10 text-primary hover:bg-primary/20 transition-all"
                  title="Exportar CSV"
                >
                ...
                <Button 
                  ...
                  className="p-spacing-xs rounded-premium-full bg-red-500/10 text-red-600 hover:bg-red-500/20 transition-all"
                  title="Exportar PDF"
                >
            ...
            {view === 'logs' && (
              <div className="flex items-center gap-spacing-xs">
                <input 
                  ...
                  className="bg-background border border-border rounded px-spacing-xs py-spacing-2xs text-premium-xs"
                />
                <input 
                  type="date" 
                  value={dateRange.end} 
                    ...
                    <tr key={item.id} className="border-b border-border/50 hover:bg-muted/20 transition-colors">
                      ...
                      <td className="px-spacing-lg py-spacing-md">
                        {item.status === 'generated' ? (
                          <span className="flex items-center gap-spacing-2xs text-premium-xs text-green-600 dark:text-green-400 font-bold">
                            <Icons.CheckCircle className="w-spacing-sm h-spacing-sm" /> Gerado
                          </span>
                        ) : item.status === 'official' ? (
                          <span className="flex items-center gap-spacing-2xs text-premium-xs text-blue-500 font-bold">
                            <Icons.CheckCircle className="w-spacing-sm h-spacing-sm" /> Oficial
                          </span>
                        ) : item.status === 'error_402' ? (
                          <span className="flex items-center gap-spacing-2xs text-premium-xs text-orange-500 font-bold">
                            <Icons.AlertTriangle className="w-spacing-sm h-spacing-sm" /> Créditos (402)
                          </span>
                        ) : (
                          <span className="flex items-center gap-spacing-2xs text-premium-xs text-destructive font-bold">
                            <Icons.XCircle className="w-spacing-sm h-spacing-sm" /> Falha
                          </span>
                        )}
                      </td>
                      <td className="px-spacing-lg py-spacing-md font-mono text-premium-xs">{item.retry_count} / 3</td>
                      <td className="px-spacing-lg py-spacing-md max-w-spacing-xs md:max-w-spacing-sm">
                        <p className="text-premium-xs truncate text-muted-foreground">
                      ...
                      <td className="px-spacing-lg py-spacing-md text-right">
                        <Button 
                          ...
                          className="p-spacing-xs rounded-premium-full hover:bg-primary/10 text-muted-foreground hover:text-primary transition-all disabled:opacity-30"
                        >
                ...
                {logs.length === 0 ? (
                  ...
                  logs.map(log => (
                    <tr key={log.id} className="border-b border-border/50 hover:bg-muted/20 transition-colors">
                      ...
                      <td className="px-spacing-lg py-spacing-md font-mono text-premium-xs text-muted-foreground">{log.duration_ms}ms</td>
                      <td className="px-spacing-lg py-spacing-md text-premium-xs text-muted-foreground truncate max-w-spacing-xs">{log.error_message || '-'}</td>
                      <td className="px-spacing-lg py-spacing-md text-right text-premium-xs text-muted-foreground font-medium">
                ...
                {[
                  ...
                  return (
                    <div key={item.field} className="space-y-spacing-xs">
                      <div className="flex justify-between text-premium-xs font-black uppercase tracking-widest">
              ...
              <div className="border border-border rounded-premium overflow-hidden">
                <table className="w-full text-left text-premium-xs">
                  <thead className="bg-muted/50 border-b border-border">
                    <tr className="text-premium-xs font-black uppercase tracking-widest text-muted-foreground">
