...
export const BibleSkeleton = () => (
  <div className="w-full max-w-7xl mx-auto space-y-2xl py-xl animate-in fade-in duration-700">
    <div className="space-y-lg text-center">
      ...
      <div className="h-xl w-4xl bg-muted/40 rounded-full mx-auto animate-pulse" />
      <div className="h-md w-4xl bg-muted/20 rounded-full mx-auto animate-pulse" />
    </div>
    
    <div className="grid grid-cols-2 md:grid-cols-4 gap-lg">
      {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
        <Card key={i} className="h-4xl rounded-premium bg-muted/20 border-border/20 animate-pulse duration-700" />
      ))}
    </div>
  </div>
);
...
export const CatechismSkeleton = () => (
  <div className="w-full max-w-5xl mx-auto space-y-2xl py-xl animate-in fade-in duration-700">
    <div className="space-y-lg text-center">
      <div className="w-2xl h-2xl rounded-premium bg-primary/5 border border-primary/10 mx-auto animate-pulse" />
      <div className="h-xl w-4xl bg-muted/40 rounded-full mx-auto animate-pulse" />
    </div>
    ...
    <div className="space-y-xl max-w-3xl mx-auto">
      {[1, 2, 3].map((i) => (
        <div key={i} className="space-y-md">
          <div className="h-xl w-4xl bg-muted/40 rounded-full animate-pulse duration-700" />
...
export const LogosSkeleton = () => (
  <div className="w-full max-w-4xl mx-auto h-[70vh] flex flex-col space-y-lg md:space-y-xl py-lg md:py-xl animate-in fade-in duration-700">
    ...
    <div className="flex-1 space-y-xl overflow-hidden">
