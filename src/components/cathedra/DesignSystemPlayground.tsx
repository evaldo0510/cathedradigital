  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <div className="app-container py-3xl md:py-4xl stack-spacing">
        {/* Header Section */}
        <section className="text-center space-y-xl">
        ...
        <section className="space-y-3xl">
          ...
          <div className="premium-card p-xl md:p-3xl space-y-3xl">
        ...
        <section className="space-y-3xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2xl pt-2xl">
            ...
            <div className="space-y-xl flex flex-col justify-end">
        ...
        <section className="space-y-3xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-xl">
            <CathedraCard padding="sm" className="space-y-md">
