...
const Footer: React.FC = React.memo(() => {
  ...
  return (
    <footer className="mt-auto w-full border-t border-primary/10 pt-20 pb-12 px-6 md:px-12 bg-black/40 backdrop-blur-sm relative overflow-hidden hidden lg:block">
