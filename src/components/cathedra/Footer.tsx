...
const Footer: React.FC = React.memo(() => {
  ...
  return (
    <footer className="mt-auto w-full border-t border-primary/10 pt-8 lg:pt-12 pb-24 lg:pb-12 px-4 sm:px-6 md:px-12 bg-foreground/[0.03] backdrop-blur-sm relative overflow-hidden">
