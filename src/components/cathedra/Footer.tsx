...
const Footer: React.FC = React.memo(() => {
  ...
  return (
    <footer className="mt-auto w-full border-t border-primary/5 pt-10 lg:pt-16 pb-24 lg:pb-16 px-6 md:px-12 bg-card/20 backdrop-blur-md relative overflow-hidden transition-all duration-500 hover:bg-card/40" style={{ contentVisibility: 'auto', containIntrinsicSize: '0 420px' }}>
