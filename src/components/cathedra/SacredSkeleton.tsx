...
export const PageHeaderSkeleton: React.FC = () => (
  <div className="text-center space-y-md pt-xl mb-xl animate-pulse">
    <div className="w-2xl h-2xl mx-auto rounded-premium bg-muted" />
    <div className="h-xl w-4xl mx-auto bg-muted rounded-premium" />
    <div className="h-md w-4xl mx-auto bg-muted/60 rounded-premium" />
  </div>
);
...
export const CardGridSkeleton: React.FC<{ count?: number }> = ({ count = 6 }) => (
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-lg animate-pulse">
    {Array.from({ length: count }).map((_, i) => (
      <Card key={i} className="h-4xl rounded-premium bg-muted/30 border border-border/40 shadow-md" />
    ))}
  </div>
);
...
export const SaintCardSkeleton: React.FC = () => (
  <div className="bg-card border border-border rounded-[2.5rem] overflow-hidden animate-pulse h-4xl">
    <div className="flex flex-col md:flex-row h-full">
      <div className="w-full md:w-2xs/3 bg-muted h-4xl md:h-auto" />
      <div className="flex-1 p-xl space-y-lg">
        <div className="h-md w-4xl bg-muted rounded" />
        <div className="h-xl w-4xl bg-muted rounded" />
...
export const SaintGridSkeleton: React.FC<{ count?: number }> = ({ count = 8 }) => (
  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-md animate-pulse">
    {Array.from({ length: count }).map((_, i) => (
      <div key={i} className="h-4xl rounded-premium bg-muted" />
    ))}
  </div>
);
...
export const BibleChapterSkeleton: React.FC = () => (
  <div className="space-y-lg animate-pulse">
    <div className="h-xl w-4xl bg-muted rounded mx-auto" />
...
export const CatechismParagraphSkeleton: React.FC<{ paragraph?: number }> = ({ paragraph }) => (
  <div className="space-y-md animate-pulse py-md">
...
export const LogosChatSkeleton = () => (
  <div className="flex flex-col h-full space-y-lg p-md animate-pulse">
...
export const ReadingSkeleton = () => (
  <div className="w-full max-w-3xl mx-auto space-y-xl py-2xl animate-in fade-in duration-700">
    <div className="space-y-md">
