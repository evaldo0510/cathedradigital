...
const OfflineModeToggle: React.FC = () => {
  ...
  return (
    <Button
      onClick={toggle}
      className={`fixed bottom-24 right-20 lg:bottom-6 lg:right-24 z-50 p-3 rounded-full border shadow-lg hover:shadow-premium transition-all group flex items-center gap-2 ${
        isOfflineMode 
