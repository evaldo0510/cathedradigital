...
const AboutPage: React.FC = () => (
  <div className="w-full space-y-3xl py-md animate-in fade-in slide-in-from-bottom-md duration-1000">
    {/* Hero Section */}
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-2xl items-start">
      {/* Missão Section */}
      <div id="missao" className="scroll-mt-4xl space-y-lg">
        ...
        <div className="space-y-md text-muted-foreground leading-relaxed text-lg">
      ...
      {/* História Section */}
      <div id="historia" className="scroll-mt-4xl space-y-lg">
        <div className="flex items-center gap-sm">
          <div className="w-xl h-xl rounded-full bg-primary/[0.02] border border-primary/10 flex items-center justify-center">
    ...
    <div className="space-y-2xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-lg">
        {[
          ...
          <div key={pillar.title} className="bg-card border border-primary/5 rounded-premium p-lg space-y-md hover:border-primary/20 transition-all group shadow-premium">
    ...
    <div className="pt-3xl border-t border-border/40">
      <div className="flex flex-col md:flex-row items-center gap-xl md:gap-3xl bg-primary/[0.01] rounded-[2.5rem] p-xl md:p-2xl border border-primary/5 shadow-premium">
        <div className="shrink-0">
          <div className="w-4xl h-4xl md:w-4xl md:h-4xl rounded-full border-4 border-background p-xs relative bg-background shadow-premium overflow-hidden group">
        ...
        <div className="space-y-lg flex-1 text-center md:text-left">
          <div className="space-y-xs">
          ...
          <div className="space-y-md text-muted-foreground text-lg leading-relaxed font-serif">
            <p>
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-sm pt-xs">
            {['Espiritualidade', 'Reflexão', 'Tecnologia', 'Tradição'].map(tag => (
              <span key={tag} className="px-md py-2xs bg-background border border-border rounded-full text-xs font-black uppercase tracking-widest text-muted-foreground">
                {tag}
              </span>
            ))}
          </div>
    ...
    {/* Footer Quote */}
    <div className="py-3xl text-center space-y-md">
