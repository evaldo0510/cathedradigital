...
const AboutPage: React.FC = () => (
  <div className="w-full space-y-spacing-3xl py-spacing-md animate-in fade-in slide-in-from-bottom-spacing-md duration-1000">
    ...
    <div className="text-center space-y-spacing-md">
      <div className="inline-flex items-center gap-spacing-xs px-spacing-md py-spacing-2xs bg-primary/[0.02] rounded-full border border-primary/10">
        <Icons.Cross className="w-spacing-md h-spacing-md text-primary" />
        <span className="text-xs font-black uppercase tracking-[0.2em] text-primary">Manifesto & Identidade</span>
      </div>
      <h1 className="text-4xl md:text-6xl font-serif font-bold text-foreground tracking-tight">Sobre a Cathedra Digital</h1>
      <p className="text-muted-foreground text-lg max-w-spacing-2xl mx-auto">Unindo a tradição milenar da Igreja à vanguarda tecnológica para a glória de Deus.</p>
    </div>

    {/* Quick Navigation Anchors */}
    <nav className="flex flex-wrap justify-center gap-spacing-xs md:gap-spacing-xl py-spacing-md border-y border-primary/5 sticky top-0 bg-background/80 backdrop-blur-md z-20">
      {[
        ...
        <a 
          key={link.href} 
          href={link.href}
          className="flex items-center gap-spacing-xs px-spacing-md py-spacing-xs text-sm font-medium text-muted-foreground/60 hover:text-primary hover:bg-primary/[0.03] rounded-full transition-all"
        >
          {link.icon}
          {link.label}
        </a>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-spacing-2xl items-start">
      ...
      <div id="missao" className="scroll-mt-spacing-4xl space-y-spacing-lg">
        <div className="flex items-center gap-spacing-sm">
          <div className="w-spacing-xl h-spacing-xl rounded-full bg-primary/[0.02] border border-primary/10 flex items-center justify-center">
        ...
        <div className="space-y-spacing-md text-muted-foreground leading-relaxed text-lg">
        ...
        <div className="flex flex-wrap justify-center gap-spacing-lg">
          {[
            ...
            <a
              ...
              className={`flex flex-col items-center gap-spacing-xs p-spacing-md rounded-full bg-background border border-primary/5 shadow-sm transition-all hover:shadow-premium hover:-translate-y-1 ${social.color} group`}
            >
              <div className="transition-transform duration-300 group-hover:scale-110">
                {social.icon}
              </div>
              <span className="text-xs font-black uppercase tracking-widest text-muted-foreground group-hover:text-inherit">
                {social.label}
              </span>
            </a>
          ))}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-spacing-lg">
        {[
          ...
          <div key={pillar.title} className="bg-card border border-primary/5 rounded-premium p-spacing-lg space-y-spacing-md hover:border-primary/20 transition-all group shadow-premium">
            <div className="text-primary/40 bg-primary/[0.01] border border-primary/5 w-spacing-3xl h-spacing-3xl rounded-full flex items-center justify-center transition-transform duration-500 group-hover:rotate-6 group-hover:text-primary group-hover:bg-primary/[0.03]">
              {pillar.icon}
            </div>
            <div className="space-y-spacing-xs">
    ...
    <div className="pt-spacing-3xl border-t border-border/40">
      <div className="flex flex-col md:flex-row items-center gap-spacing-xl md:gap-spacing-3xl bg-primary/[0.01] rounded-[2.5rem] p-spacing-xl md:p-spacing-2xl border border-primary/5 shadow-premium">
        <div className="shrink-0">
          <div className="w-spacing-4xl h-spacing-4xl md:w-spacing-4xl md:h-spacing-4xl rounded-full border-4 border-background p-spacing-xs relative bg-background shadow-premium overflow-hidden group">
        ...
        <div className="space-y-spacing-lg flex-1 text-center md:text-left">
          ...
          <div className="space-y-spacing-md text-muted-foreground text-lg leading-relaxed font-serif">
            <p>
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-spacing-sm pt-spacing-xs">
            {['Espiritualidade', 'Reflexão', 'Tecnologia', 'Tradição'].map(tag => (
              <span key={tag} className="px-spacing-md py-spacing-2xs bg-background border border-border rounded-full text-xs font-black uppercase tracking-widest text-muted-foreground">
                {tag}
              </span>
            ))}
          </div>
