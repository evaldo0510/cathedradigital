  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <div className="w-24 h-24 md:w-32 md:h-32 rounded-2xl overflow-hidden border-[3px] border-secondary/50 shadow-2xl bg-primary">
        ...
        <motion.div className="absolute bottom-12 w-32 h-0.5 bg-white/5 rounded-2xl overflow-hidden">
          <motion.div
            initial={{ width: '0%' }}
            animate={{ width: '100%' }}
