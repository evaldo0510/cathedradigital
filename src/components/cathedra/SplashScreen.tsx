      ...
      >
        ...
        {[...Array(6)].map((_, i) => (
          <motion.div
            ...
            className="absolute w-2xs h-2xs rounded-full bg-primary"
          />
        ))}
        ...
        >
          <div className="w-4xl h-4xl md:w-4xl md:h-4xl rounded-premium overflow-hidden border-[1px] border-primary/5 shadow-premium-hover bg-background/50 backdrop-blur-md">
            <Icons.Logo className="w-full h-full p-md opacity-40" variant="dark" />
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="relative z-10 mt-xl text-center"
        >
          <motion.h2
          ...
          <motion.p aria-hidden="true"
            ...
            className="text-[8px] md:text-[10px] font-bold uppercase tracking-[0.4em] text-primary/30 mt-sm"
          >
            Digital Sanctuarium
          </motion.p>
        </motion.div>

        <motion.div className="absolute bottom-2xl w-4xl h-3xs bg-card/50 rounded-premium overflow-hidden">
          <motion.div
            initial={{ width: '0%' }}
            animate={{ width: '100%' }}
