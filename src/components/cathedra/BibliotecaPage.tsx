    ...
    items: [
      {
        ...
        icon: <Icons.Bible className="w-md h-md" />,
      ...
      },
      {
        ...
        icon: <Icons.Catechism className="w-md h-md" />,
      ...
      },
      {
        ...
        icon: <Icons.ScrollText className="w-md h-md" />,
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: <Icons.Liturgy className="w-md h-md" />,
      ...
      },
      {
        ...
        icon: <Icons.Volume2 className="w-md h-md" />,
      ...
      },
      {
        ...
        icon: <Icons.Lectio className="w-md h-md" />,
    ...
    items: [
      {
        ...
        icon: <Icons.Brain className="w-md h-md" />,
      ...
      },
      {
        ...
        icon: <Icons.Aquinas className="w-md h-md" />,
      ...
      },
      {
        ...
        icon: <Icons.Library className="w-md h-md" />,
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-lg">
                {group.items.map((item, i) => (
                  <CathedraCard
                    ...
                    className="flex flex-col gap-lg group"
                  >
