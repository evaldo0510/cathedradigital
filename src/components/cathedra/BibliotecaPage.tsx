...
const sections = [
  ...
  {
    title: 'Ladainhas',
    description: 'Preces litânicas da tradição da Igreja',
  ...
  {
    title: 'Missa',
    description: 'O Ordinário da Missa (Ordo Missae)',
    icon: <Icons.Church className="w-5 h-5" />,
    route: AppRoute.ORDO_MISSAE,
    color: 'bg-accent/10 text-accent',
  },
  {
    title: 'Os Papas',
  ...
  {
    title: 'Aparições',
    description: 'Manifestações de Nossa Senhora',
