...
const Relatio: React.FC<RelatioProps> = ({ 
  ...
  return (
    <section ref={containerRef} className={cn("mt-spacing-xl pt-spacing-xl md:mt-spacing-2xl md:pt-spacing-2xl border-t border-primary/[0.01] space-y-spacing-md md:space-y-spacing-lg mb-spacing-xl md:mb-spacing-2xl w-full", className)} aria-labelledby="relatio-heading">
