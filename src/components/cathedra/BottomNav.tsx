...
const BottomNav: React.FC<BottomNavProps> = ({ user, onOpenSidebar }) => {
  ...
  return (
    <nav 
      className={cn(
        "fixed bottom-4 left-4 right-4 z-[160] lg:hidden h-10 bg-background/5 rounded-full shadow-none border border-primary/[0.0005] dark:border-white/[0.001] bottom-nav bottom-nav-reading-auto-hide px-3 overflow-hidden transition-all backdrop-blur-md",
